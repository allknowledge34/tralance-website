    ...
    <section className="py-24 bg-white dark:bg-[#0B1020]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-500 dark:text-[#AEB7C6] max-w-3xl mx-auto">
            One private workspace for the tools, money, projects, and everyday work behind your freelance business.
          </p>
        </div>

        <div className="overflow-x-auto pb-8">
          <div className="min-w-[800px] bg-slate-50 dark:bg-[#1A2238] rounded-3xl border border-slate-200 dark:border-[rgba(255,255,255,0.08)] shadow-sm overflow-hidden">
            
            <div className="grid grid-cols-4 bg-white dark:bg-[#111827] border-b border-slate-200 dark:border-[rgba(255,255,255,0.08)]">
              <div className="p-4 sm:p-6 flex items-center font-bold text-slate-900 dark:text-white">Features</div>
              ...
              <div className="p-4 sm:p-6 flex items-center justify-center text-center font-bold text-sm sm:text-base text-slate-600 dark:text-slate-400 border-l border-slate-200 dark:border-[rgba(255,255,255,0.08)]">Traditional Tools</div>
              <div className="p-4 sm:p-6 flex items-center justify-center text-center font-bold text-sm sm:text-base text-slate-600 dark:text-slate-400 border-l border-slate-200 dark:border-[rgba(255,255,255,0.08)]">Generic SaaS Platforms</div>
            </div>

            <div className="divide-y divide-slate-200 dark:divide-[rgba(255,255,255,0.08)]">
              {COMPARISONS.map((item, idx) => (
                <div 
                  key={idx} 
                  className="grid grid-cols-4 hover:bg-white dark:hover:bg-[#111827]/50 transition-colors duration-200"
                >
                  <div className="p-4 sm:p-6 flex items-center text-xs sm:text-sm font-medium text-slate-700 dark:text-[#AEB7C6]">{item.feature}</div>
                  
                  <div className="p-4 sm:p-6 flex items-center justify-center border-l border-slate-200 dark:border-[rgba(255,255,255,0.08)] bg-blue-50/30 dark:bg-[#3B82F6]/5">
                    {renderCell(item.tralance, true)}
                  </div>
                  
                  <div className="p-4 sm:p-6 flex items-center justify-center border-l border-slate-200 dark:border-[rgba(255,255,255,0.08)]">
