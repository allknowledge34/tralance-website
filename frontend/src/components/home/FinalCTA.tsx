  ...
  return (
    <section className="pt-16 pb-32 sm:pt-24 sm:pb-40 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className="relative rounded-[40px] bg-gradient-to-b from-slate-900 to-slate-950 dark:bg-[#1A2238] dark:from-[#1A2238] dark:to-[#1A2238] text-white px-8 py-16 sm:px-16 sm:py-20 text-center border border-slate-800 dark:border-[rgba(255,255,255,0.08)] shadow-2xl"
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              <a
                ...
                className="w-full sm:w-[220px] inline-flex items-center justify-center sm:justify-start gap-4 px-6 py-3 rounded-2xl bg-[#0A0D14] text-white hover:bg-black font-bold transition-all hover:scale-102 active:scale-95 shadow-xl shadow-black/20"
              >
