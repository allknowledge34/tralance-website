      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 border-t border-slate-200/60 dark:border-white/5 print:hidden">
        ...
        <div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">What is a freelance contract?</h3>
              <p className="text-slate-600 dark:text-slate-400">A freelance contract is a legally binding agreement between a freelancer and a client that outlines the scope of work, payment terms, deadlines, and other important project details.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">No. The Freelance Contract Generator runs entirely in your web browser. No client data, project details, or personal information is ever sent to or stored on our servers.</p>
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Can I customize the contract terms?</h3>
              <p className="text-slate-600 dark:text-slate-400">Yes, you have full control over the payment structure, revision limits, intellectual property terms, confidentiality agreements, and cancellation policies.</p>
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Do I need to create an account?</h3>
              <p className="text-slate-600 dark:text-slate-400">No, you do not need to create an account or log in to use the contract generator. It is 100% free and open to use immediately.</p>
            </div>
          </div>
        </div>
